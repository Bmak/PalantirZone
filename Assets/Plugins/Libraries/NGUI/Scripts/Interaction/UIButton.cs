...
public class UIButton : UIButtonColor
{
    ...
    //Embria Ventures ProBigi

    private bool _isLock;
    public bool IsLock { get { return _isLock; } }

    private State _blockState;
    public State BlockState { get { return _blockState; } }

    public virtual void SetIsLock(bool lockState)
    {
        _isLock = lockState;
    }

    public virtual void SetBlockState(State blockState)
    {
